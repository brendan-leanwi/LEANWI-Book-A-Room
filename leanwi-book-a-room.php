...
function leanwi_update_check() {
    $current_version = get_option('leanwi_booking_plugin_version', '1.4.8'); // Default to an old version if not set
    $new_version = '1.4.15'; // Update this with your plugin's actual version
