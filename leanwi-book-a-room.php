...
function leanwi_update_check() {
    $current_version = get_option('leanwi_booking_plugin_version', '1.4.17'); // Default to an old version if not set
    $new_version = '1.4.21'; // Update this with the new plugin version
