...
function leanwi_update_check() {
    $current_version = get_option('leanwi_plugin_version', '1.0.0'); // Default to an old version if not set
    $new_version = '1.3.11'; // Update this with your plugin's actual version
