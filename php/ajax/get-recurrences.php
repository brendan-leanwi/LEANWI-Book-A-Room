...
add_action('wp_ajax_leanwi_get_recurrences', __NAMESPACE__ . '\\leanwi_get_recurrences');
add_action('wp_ajax_nopriv_leanwi_get_recurrences', __NAMESPACE__ . '\\leanwi_get_recurrences');

function leanwi_get_recurrences() {
    global $wpdb;
    ...
    wp_send_json_success($sanitized_recurrences, JSON_UNESCAPED_SLASHES);
}