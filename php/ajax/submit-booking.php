...
add_action('wp_ajax_leanwi_submit_booking', __NAMESPACE__ . '\\leanwi_submit_booking');
add_action('wp_ajax_nopriv_leanwi_submit_booking', __NAMESPACE__ . '\\leanwi_submit_booking');

function leanwi_submit_booking() {
