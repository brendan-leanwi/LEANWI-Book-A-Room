...
add_action('wp_ajax_leanwi_add_recurring_bookings', __NAMESPACE__ . '\\leanwi_add_recurring_bookings');
add_action('wp_ajax_nopriv_leanwi_add_recurring_bookings', __NAMESPACE__ . '\\leanwi_add_recurring_bookings');

function leanwi_add_recurring_bookings() {
    global $wpdb;
    ...
    try {
        ...
        foreach ($recurringDates as $booking) {
            ...
            $participant_inserted = $wpdb->insert("{$wpdb->prefix}leanwi_booking_participant", [
                'unique_id' => $unique_id,
                'venue_id' => $venue_id,
